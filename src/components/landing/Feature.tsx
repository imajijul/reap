      ...
      <Container>
        ...
        <div className="grid sm:grid-cols-2 gap-10 sm:px-24">
          ...
          <Container delay={.3}>
            ...
            <div className="flex items-center justify-between gap-2 mt-5">
              <div className="flex items-center justify-center bg-white rounded min-w-[90%]">
                <input
                  ...
                  className="outline-none bg-transparent placeholder:font-bold font-semibold ps-2 pe-3 w-full"
                />
            ...
            <h1 className="text-xl font-semibold sm:my-3">
          ...
          <Container delay={.3}>
            ...
            <h1 className="text-xl font-semibold sm:my-3">
              Trace every case, <br /> in one place{" "}
            </h1>
            <p className="text-gray-600 py-1">
              Your team gets guided, support not guesswork.
            </p>
